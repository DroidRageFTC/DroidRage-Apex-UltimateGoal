package org.firstinspires.ftc.teamcode.auton.red.left;
...
@Autonomous(name = "Red Left Autonomous", group = "Red")
        ...
        schedule(
                new SelectCommand(new HashMap<Object, Command>() {{
                    put(RingPipelineEx.Stack.FOUR, new SequentialCommandGroup(
                            new org.firstinspires.ftc.teamcode.auton.red.left.RedLeftFourCommand(drivetrain, shooterWheels, feeder, intake, wobbleGoalArm, vision, telemetry)
                    ));
                    put(RingPipelineEx.Stack.ONE, new SequentialCommandGroup(
                            new org.firstinspires.ftc.teamcode.auton.red.left.RedLeftOneCommand(drivetrain, shooterWheels, feeder, intake, wobbleGoalArm, vision, telemetry)
                    ));
                    put(RingPipelineEx.Stack.ZERO, new SequentialCommandGroup(
                            new org.firstinspires.ftc.teamcode.auton.red.left.RedLeftZeroCommand(drivetrain, shooterWheels, feeder, intake, wobbleGoalArm, vision, telemetry)
                    ));
