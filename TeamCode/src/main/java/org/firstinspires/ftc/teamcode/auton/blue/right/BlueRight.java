...
@Autonomous(name = "Blue Right Autonomous", group = "Red")
public class BlueRight extends MatchOpMode {
    ...
    public void robotInit() {
        ...
        vision = new Vision(hardwareMap, telemetry, VisionConstants.BLUE_RIGHT_VISION.TOP_HEIGHT, VisionConstants.BLUE_RIGHT_VISION.BOTTOM_HEIGHT, VisionConstants.BLUE_RIGHT_VISION.WIDTH);
        ...
        schedule(
                new SelectCommand(new HashMap<Object, Command>() {{
                    put(RingPipelineEx.Stack.FOUR, new SequentialCommandGroup(
                            new org.firstinspires.ftc.teamcode.auton.blue.right.BlueRightFourCommand(drivetrain, shooterWheels, feeder, intake, wobbleGoalArm, vision, telemetry)
                    ));
                    put(RingPipelineEx.Stack.ONE, new SequentialCommandGroup(
                            new org.firstinspires.ftc.teamcode.auton.blue.right.BlueRightOneCommand(drivetrain, shooterWheels, feeder, intake, wobbleGoalArm, vision, telemetry)
                    ));
                    put(RingPipelineEx.Stack.ZERO, new SequentialCommandGroup(
                            new org.firstinspires.ftc.teamcode.auton.blue.right.BlueRightZeroCommand(drivetrain, shooterWheels, feeder, intake, wobbleGoalArm, vision, telemetry)
                    ));
