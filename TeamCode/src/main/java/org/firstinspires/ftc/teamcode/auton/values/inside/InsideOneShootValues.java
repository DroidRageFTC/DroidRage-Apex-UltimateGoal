...
public class InsideOneShootValues extends SequentialCommandGroup {
    public InsideOneShootValues(Drivetrain drivetrain, ShooterWheels shooterWheels, ShooterFeeder feeder) {
